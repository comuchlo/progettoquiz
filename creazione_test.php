...
<form id="formId" action="elabora_nuovo_test.php" method="POST" onSubmit="return formSubmit('formId');">

<div class="m-3">
    <label for="nome">Nome test</label>
    <input required type="text" class="form-control" id="nome" name="nome" placeholder="Nome test">
</div>
...
<div class="d-flex justify-content-center py-1">
    <div class="btn-group-vertical">
        <button type="button"  class="btn btn-outline-secondary btn-sm" onclick="aggiungi_domanda_aperta()">
        ...
        <button type="button"  class="btn btn-outline-secondary btn-sm" onclick="aggiungi_scelta_multipla()">
...
<div class="d-flex justify-content-center py-1">
    <button type="submit"  class="btn btn-outline-success btn" >Salva</button>
</div>
...
<script type="text/javascript">
    ...
    function aggiungi_domanda_sm(id_parent) {
        ...
        pasqualini.innerHTML=innerHTML='<div class="col-auto"><div class="form-check"><input type="checkbox" class="form-check-input" name="domande['+id_parent+'][][]"></div></div> <div class="col-auto"><input required type="text" class="form-control" placeholder="domanda" name="domande['+id_parent+'][][]"></div><div class="col-auto"><button type="button" class="btn btn-outline-danger" onclick="elimina_risposta_multipla('+cm+')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16"><path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5M11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47M8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5"/></svg></button></div></div>';
        document.getElementById("risposte"+id_parent).appendChild(pasqualini);
        cm++;
    }

    function invia_form() {
        const p=document.getElementsByName("domande");
        console.log(p);

        for (let i = 0; i < p.length; i++) {
            console.log(p[i].values);
